...
@WebServlet("/camplist")
public class camplist extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<BoardDTO> bList = bSvc.BList(startRow, endRow);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("camplist.jsp");
