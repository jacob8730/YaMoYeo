...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			...
			<a href="index.jsp"><img src="assets/img/ya.png" href="index.jsp" alt="" width="95px" height="35px"></a>
	...
	<div class="container">
		...
		<header style="text-align: center">
			<div style="background-image: url('assets/img/campe.jpg')">	<br><br><br><br><br>
			<h3 class="text-white">야외활동 살펴보기</h3>
			<h5 class="text-white">전 세계 야외활동 Meetup 그룹들은 현재 어떤 활동을 하고 있을까요? 내가 참여할 수 있는 Meetup이 주변에 있는지 찾아보세요.</h5>
			<br> <a onclick="location.href='LoginForm.jsp'" class="btn btn-primary btn-lg">회원가입</a><br><br><br><br><br>
			</div>
		</header>
		<br>
          ...
          <form>
            <div class="form-row">
              <div class="col-12 col-md-9 mb-2 mb-md-0">
                <input type="text" class="form-control form-control-lg" placeholder="야외활동">
              </div>
					...
					<div class="col-lg-3 col-md-6 mb-4">
						<div class="card h-100">
							<img class="card-img-top" src="fileUpload/${board.zFile}" alt=""
								height="200px">
							<div class="card-body">
								<a href="boardView?zNum=${board.zNum}&page=${paging.page}">${board.zTitle}</a>
							</div>
							<div class="card-footer" id="di">
								<a href="campView.jsp" class="btn btn-primary">보기</a>
							</div>
						</div>
					</div>
