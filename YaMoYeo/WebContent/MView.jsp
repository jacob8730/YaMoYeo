...
<body>
	...
	<div class="container">
		...
		<table>
			...
			<tr>
				<th>사진</th>
				<td><img src="fileUpload/${member.yFile}" width="200px"></td>
			</tr>
			<tr>
				<td colspan="2" style="text-align: center">
					<button onclick="location.href='memberModifyForm?yId=${member.yId}'">수정하기</button>

					<c:if test="${sessionScope.loginId eq member.yId}">
						<button onclick="location.href='memberDelete?yId=${member.yId}'">탈퇴하기</button>
					</c:if>
